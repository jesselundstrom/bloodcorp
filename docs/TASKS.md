...
- **Arena battle polish + visual layer** - contextual isometric highlights, wrapper-based unit visuals with shadows/rings/status indicators, first-pass generated animation sheets with atlas fallback, tweened path movement, melee/ranged/crit feedback, down fades, and compact active-unit HUD. *(2026-06-02)*
