...
- **Arena battle polish + visual layer** - contextual isometric highlights, wrapper-based unit visuals with shadows/rings/status indicators/raised floating HP bars, normalized padded animation sheets with quiet idle, generated broadcast arena background, bounded board projection, cleaner starting formations, ticker combat log, compact scorebug/command deck HUD, atlas fallback, tweened path movement, melee/ranged/crit feedback, and down fades. *(2026-06-02; HUD polish 2026-06-03)*
